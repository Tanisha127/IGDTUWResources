...
class ECEAI8thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eceai_8th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 8 (ECEAI)"
