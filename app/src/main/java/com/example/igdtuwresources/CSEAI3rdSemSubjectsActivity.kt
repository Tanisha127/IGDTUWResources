...
class CSEAI3rdSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cseai_3rd_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 3 (CSEAI)"
