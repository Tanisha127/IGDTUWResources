...
class MAE2ndSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mae_2nd_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 2 (MAE)"
        ...
        subjectListView.setOnItemClickListener { _, _, position, _ ->
            ...
            intent.putExtra("branch", "MAE")
            intent.putExtra("semester", "2nd")
