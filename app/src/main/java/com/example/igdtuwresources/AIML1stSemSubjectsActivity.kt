...
class AIML1stSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_1st_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 1 (AIML)"
