...
class AIML6thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_6th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 6 (AIML)"
