...
class AIML8thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_8th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 8 (AIML)"
