...
class CSEAI7thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cseai_7th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 7 (CSEAI)"
