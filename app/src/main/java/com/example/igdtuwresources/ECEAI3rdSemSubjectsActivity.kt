...
class ECEAI3rdSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eceai_3rd_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 3 (ECEAI)"
