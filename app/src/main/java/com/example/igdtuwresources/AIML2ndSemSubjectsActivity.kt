...
class AIML2ndSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_2nd_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 2 (AIML)"
