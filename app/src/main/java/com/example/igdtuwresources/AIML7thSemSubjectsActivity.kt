...
class AIML7thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_7th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 7 (AIML)"
