...
class CSEAI8thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cseai_8th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 8 (CSEAI)"
        ...
        subjectListView.setOnItemClickListener { _, _, position, _ ->
            ...
            intent.putExtra("branch", "CSEAI")
            intent.putExtra("semester", "8th")
