...
class AIML4thSemSubjectsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aiml_4th_sem_subjects)
        ...
        // Set the header text
        subjectHeader.text = "Subjects for Semester 4 (AIML)"
